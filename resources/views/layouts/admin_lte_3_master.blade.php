...
@include('partials.nav_admin_lte_3')

<!-- Main Sidebar Container -->
@include('partials.sidebar_menu_admin_lte_3')
<!-- /.Main Sidebar Container -->
...
@include('partials.footer_admin_lte_3')
...
@include('partials.js_admin_lte_3')
